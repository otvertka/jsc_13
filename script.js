...
// LECT .
// DOMContentLoaded происходит когда весь HTML был полностью загружен и пройден парсером, не дожидаясь окончания загрузки таблиц стилей, изображений и фреймов
document.addEventListener('DOMContentLoaded', function (e) {
  console.log('HTML parsed and DOM tree built!', e);
});
// Событие load происходит когда ресурс и его зависимые ресурсы закончили загружаться.
window.addEventListener('load', function (e) {
  console.log('Page lload', e);
});

// Задать вопрос при закрытии, перезагр. страницы (ЗАКРЫТЬ/ПЕРЕЗАГРУЗИТЬ ? Возможно, внесенные изменения не сохранятся.)
