...
tabsContainer.addEventListener('click', function (e) {
  ...
  // Active tab
  tabs.forEach(t => t.classList.remove('operations__tab--active')); // удаляем класс Актив вначале, чтобы неактивная кнопка уходила вниз
  ...
  document
    .querySelector(`.operations__content--${clicked.dataset.tab}`) // считывает цифру Датасет из нажатой кнопки,
